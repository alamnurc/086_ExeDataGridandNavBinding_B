...
{
    public partial class Form_DataBindingNavigation : Form
    {
        public Form_DataBindingNavigation()
        {
            InitializeComponent();
        }
        ...
        private void Form_DataBindingNavigation_Load(object sender, EventArgs e)
        {
